{
  ...
  "metadata": {
    "colab": {
      ...
      "collapsed_sections": [],
      "toc_visible": true,
      "authorship_tag": "ABX9TyOHGK5f4v/cltD9wtAM8fT1",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/DaniilGlubshevAndr/LaboratoryWork3/blob/main/Filter.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        ...
        "id": "QEia1gA75Hre",
        "outputId": "e9f33e38-509f-4537-eae7-145d6b13fc80"
      },
      "source": [
        "import numpy as np\r\n",
        ...
        "kernel = SourceModule(\r\n",
        "    \"\"\"\r\n",
        "    __global__ void filter_s_and_p(unsigned char* pixels, unsigned char* filtered, int* size){\r\n",
        ...
        ")\r\n",
        "\r\n",
        "filter_s_and_p = kernel.get_function(\"filter_s_and_p\")\r\n",
        "\r\n",
      ...
      "outputs": [
        {
          "output_type": "stream",
          "text": [
            "Имя файла: 512.bmp  -  на CPU 2092.51941, на GPU 0.59717, ускорение 3504.08477\n",
            "Имя файла: 1024.bmp -  на CPU 8668.02434, на GPU 1.56127, ускорение 5551.89359\n"
          ],
          "name": "stdout"
        }
      ]
